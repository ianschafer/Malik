...
//
// Modified by Ian A Schafer to add mergeLists function.
//***********************************************************
...
public:
    ...
    void mergeLists(orderedLinkedList<Type>& newList, orderedLinkedList<Type>& list1, orderedLinkedList<Type>& list2);
      //Function creates a new list by merging the elements of list1 and list2.
...
template<class Type>
void orderedLinkedList<Type>::mergeLists(orderedLinkedList<Type>& newList,orderedLinkedList<Type> &list1, orderedLinkedList<Type> &list2)
{
    cout << endl;
    cout << "What did mergeLists() receive? .. " << endl;

    cout << "Function printing list1 .. ";
    list1.print();
    cout << endl;

    cout << "Function printing list2 .. ";
    list2.print();
    cout << endl;

    cout << "Function printing newList .. ";
    newList.print();
    cout << endl << endl;

    cout << "MERGING lists .. " << endl << endl;

    while ((list1.first != NULL)&&(list2.first != NULL))
    {
        newList.insertFirst(list1.front());
        list1.deleteNode(list1.front());
        cout << "Function printing list1 .. ";
        list1.print();
        cout << endl;

        newList.insertFirst(list2.front());
    ...
    cout << "<------- Exiting mergeLists() function <-------" << endl;
    cout << endl;
